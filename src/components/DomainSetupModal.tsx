...
import { Globe, X, ExternalLink, CheckCircle, ShieldCheck, ArrowRight, Copy, Check } from 'lucide-react';
...
export default function DomainSetupModal({ isOpen, onClose }: DomainSetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-2xl glass-panel border border-cyan-accent/30 rounded-3xl p-6 sm:p-8 bg-gradient-to-b from-navy-card via-navy-dark to-brand-black shadow-2xl text-left space-y-6 max-h-[90vh] overflow-y-auto">
